    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-blue-400">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <ol className="list-inside list-decimal text-sm text-center sm:text-left font-[family-name:var(--font-geist-mono)]">
          <li className="mb-2">
           Welcome to Azarias' Next.js App{" "}
            .
          </li>
          <li>Click on the link to visit Azarias' Github Repository</li>
        </ol>

        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-foreground text-background gap-2 hover:bg-[#383838] dark:hover:bg-[#ccc] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
            href="https://github.com/AzariasANeals?tab=repositories"
            target="_blank"
        ...
        <div className="h-screen flex flex-col items-center justify-center transition-all" style={{ backgroundColor: bgColor }}>
      <h1 className="text-2xl font-bold mb-4 text-white">Click the button to generate a random color</h1>
      <button
